...
k8s-cost uses a **dual-license model**: open source for the community,
...
The k8s-cost core is licensed under the
...
1. Use k8s-cost commercially with **>50 managed agents** and **>$5M revenue/year**
2. Distribute k8s-cost inside a product **without** releasing your source under AGPLv3
3. Offer k8s-cost as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer k8s-cost
...
Contributors to k8s-cost must sign a Contributor License Agreement (CLA).
